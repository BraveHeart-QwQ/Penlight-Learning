...
local compare, find_if, compare_no_order, imap, reduce, count_map = tablex.compare, tablex.find_if,
    tablex.compare_no_order, tablex.imap, tablex.reduce, tablex.count_map
...
function equals(e1, e2)
    ...
    if p1 ~= p2 then
        return false
    end -- different kinds of animals!
